...
В текущей версии **Distributor** умеет забирать конфигурационные файлы с GitLab, куда балансировщики пушат свою конфигурацию как `/usr/local/etc/{nginx,haproxy}/*`
